...
public class FormAnggota1841720002Andy extends javax.swing.JFrame {
    ...
    public void tampilkanDataAndy(){
        ...
        for (Anggota1841720002Andy ang : list) {
            rowData[0] = ang.getIdAnggotaAndy();
            rowData[1] = ang.getNamaAndy();
            rowData[2] = ang.getAlamatAndy();
            rowData[3] = ang.getTeleponAndy();
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        ang.setIdAnggotaAndy(Integer.parseInt(txtIdAnggota.getText()));
        ang.setNamaAndy(txtNama.getText());
        ang.setAlamatAndy(txtAlamat.getText());
        ang.setTeleponAndy(txtTelepon.getText());
        ang.saveAndy();
        txtIdAnggota.setText(Integer.toString(ang.getIdAnggotaAndy()));
        tampilkanDataAndy();
